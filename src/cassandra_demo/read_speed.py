...
statement_local_one = SimpleStatement(
    "SELECT * FROM three_dc_three_replicas.mytable;",
    consistency_level=ConsistencyLevel.LOCAL_ONE
)
result = session.execute(statement_local_one, trace=True)
trace = result.get_query_trace()
print_trace(trace, "Read Consistency level: LOCAL_ONE", "READ_LOCAL_ONE.txt")
...
trace = result.get_query_trace()
print_trace(trace, "Read Consistency level: LOCAL_QUORUM", "READ_LOCAL_QUORUM.txt")
...
trace = result.get_query_trace()
print_trace(trace, "Read Consistency level: EACH_QUORUM", "READ_EACH_QUORUM.txt")
...
trace = result.get_query_trace()
print_trace(trace, "Read Consistency level: ALL", "READ_ALL.txt")